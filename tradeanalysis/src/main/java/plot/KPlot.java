...
public class KPlot {
    public static void main(String[] args) {
        ...
        series.add(new Day(26, 9, 2007), 7.9, 7.86, 7.83, 7.96);
...
//// 为了能够保证K线图的上影线和下影线能够和K线图本身的颜色保持一致，找了很多的方法设置都不成功，
//   可以说目前暂不提供单独绘制K线边框颜色的方法，所以，经过本人的实验，对其中的源代码进行了下修改，
//   具体修改的地方是在下载回来的文件目中source\org\jfree\chart\renderer\xy\CandlestickRenderer.java文件，
//   将
...
//}
//
//// 修改为如下的代码，这样就会保证K线图的上影线和下影线能够和K线图本身的颜色保持一致，
// 符合中国股票市场K线图形颜色的习惯：
//Paint p = getItemPaint(series, item);
//           Paint outlinePaint = null;
